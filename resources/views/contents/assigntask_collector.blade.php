        ...
        <div class="row">
          ...
          <div class="col-md-12">
              <div class="card card-success">
                    ...
                    <h3 class="card-title">Assign Task for Collector</h3>
                    </div>
                    <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                        <label for="name">Collector thực hiện</label>
                        ...
                        <div class="form-group">
                        <label for="object1">Chọn route</label>
                        <select id="object1" name="object1" class="form-control" style="width: 100%;">
                        <option selected="selected">Route 1</option>
                        </select>
                        </div>
                        <div class="form-group">
                        <label for="object2">Chọn phương tiện</label>
                        <select id="object2" name="object2" class="form-control" style="width: 100%;">
                        <option selected="selected">Vehicle 1</option>
                        </select>
                        </div>
                        <div class="form-group">
